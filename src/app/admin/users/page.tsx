  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 animate-slide-in-up">
        <div>
          <h1 className="text-display text-2xl sm:text-3xl font-bold text-[#0a1628]">Kelola Pengguna</h1>
          <p className="text-[#64748b] text-sm sm:text-base mt-1">Daftar seluruh pengguna sistem</p>
        </div>
        <CreateUserDialog />
      </div>

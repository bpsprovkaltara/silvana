  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-[#0a1628] to-[#1a2942] text-white w-72">
      ...
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/50">Panel Administrator</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#d4744a] to-[#b85d38] flex items-center justify-center text-sm font-semibold">
